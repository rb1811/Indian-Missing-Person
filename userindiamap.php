		...
		<div class="container-fluid">
		  <div class="row">
			...
			<div id="page-wrapper" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<!-- India Map -->
				<img src="india.jpg"  alt="Planets" usemap="#indiamap">
				<map name="indiamap">
	 ...
	 <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			...
			<a href = "userstatistics.php"><button type="button" class="btn btn-primary">View Full Statistics</button></a>
		  </div>
		</div>
	  </div>
	</div>
	...
	/*$returnurl = urlencode(isset($_POST["returnurl"])?$_POST["returnurl"]:"");
		...
		if(isset($_POST['adminlogin'])){
			...
			{ 
				...
				clearsessionscookies();
				header("location: userindiamap.php");
			}
		}
