#This file fetches the missingperson and the contactperson details 
#We dump the MissingPerson's or the ContactPerson's UID in searchuid.json file and the output is stored in searchuidoutput.json file
import json
import requests
